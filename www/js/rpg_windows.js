...
Window_EquipStatus.prototype.drawItem = function (x, y, paramId) {
    ...
    if (this._actor) {
        this.drawCurrentParam(x + 40, y, paramId);
    }
    this.drawRightArrow(x + 100, y);
    if (this._tempActor) {
        this.drawNewParam(x + 120, y, paramId);
    }
};
...
Window_EquipSlot.prototype.drawItem = function (index) {
    if (this._actor) {
        ...
        this.drawItemName(this._actor.equips()[index], rect.x + 20, rect.y);
        this.changePaintOpacity(true);
    }
};
...
Window_ShopNumber.prototype.buttonY = function () {
    return Math.round(this.priceY() + this.lineHeight() * 1.3);
};
...
Window_Message.prototype.updatePlacement = function () {
    ...
    if (this._positionType === 2) this.y = 250;
};
