...
*/
/*:ja
* @plugindesc v1.01 (要 YEP_ItemCore.js) アイテムメニューの下の様々なカテゴリにアイテムを割り当てます
* @author Yanfly Engine Plugins + Sylvester Collaboration
*
* @param ---一般---
* @default
...
* プラグインパラメータに移動してリストを変更します。
* 各カテゴリはカンマ(,)で区切ります。
* 各カテゴリは、次の形式で正しく記入する必要があります。
*
* -----------------------   --------------------------------------------------  * Plugin Parameter Syntax   Description
* -----------------------   --------------------------------------------------  *
* Items                     通常のアイテムタイプのみを表示
* AllItems                  重要アイテムを含む全てのアイテムを表示
*
* RegularItems              通常のアイテムタイプのみを表示
* KeyItems                  重要アイテムのみを表示
* HiddenItemA               非表示アイテムAタイプのみを表示
* HiddenItemB               非表示アイテムBタイプのみを表示
* Consumable                消耗品のみを表示
* Nonconsumable             消耗品以外の商品のみを表示
* AlwaysUsable              常に使用可能なアイテムのみを表示
* BattleUsable              戦闘で使えるアイテムのみを表示
* FieldUsable               フィールドで使用可能なアイテムのみを表示
* NeverUsable               使用できないアイテムのみを表示
*
* Weapons                   全ての武器を表示
